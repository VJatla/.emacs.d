...
(custom-theme-set-faces
 'yantra
 '(default ((t (:family "Noto Sans Mono" :foundry "GOOG" :width normal :height 109 :weight normal :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "#D8DEE9" :background "#2E3440" :stipple nil :inherit nil))))
...
(custom-set-faces
 ...
 '(org-level-2 ((t (:inherit outline-1 :extend nil :height 1.75))))
 '(org-level-3 ((t (:inherit outline-1 :extend nil :height 1.5))))
 '(org-level-4 ((t (:inherit outline-1 :extend nil :height 1.25)))))

(provide-theme 'yantra)
