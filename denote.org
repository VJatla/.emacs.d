...
#+begin_src emacs-lisp
  ...
  (setq denote-directory (expand-file-name "~/Dropbox/notes/org/"))
  (when (and (string= (system-name) "vihara") (string= (user-login-name) "vjatla"))
    (setq denote-directory (expand-file-name "~/Dropbox/FBRI/notes/"))
    (setq denote-file-type 'markdown-yaml))
  (when (and (string= (system-name) "VT000504741") (string= (user-login-name) "vjatla"))
    (setq denote-directory (expand-file-name "~/Dropbox/FBRI/notes/"))
    (setq denote-file-type 'markdown-yaml))
  ...
  ;; right away) <--- Enable if using Markdown
